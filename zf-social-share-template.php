<div class="zf-social-links">
	...
	<li class="social-links__item social-links__item--linkedin">
		<a href="https://www.linkedin.com/shareArticle?mini=true&amp;url=<?php echo urlencode( esc_url( get_permalink( get_the_ID() ) ) ); ?>&amp;title=<?php the_title(); ?>" target="_blank" rel="noopener noreferrer" class="social-links__link--linkedin">
